...
import AxisBottom, { AxisBottomProps } from './axis-buttom';
...
const RacingAxisBottom = forwardRef(function ForwardRacingAxisBottom(
  ...
  const springProps = useSpring({
    from: {
      x: props.scale(prevFrameIdx) + props.scale.bandwidth() / 2 - props.cursorWidth / 2,
    },
    to: {
      x: props.scale(props.frameIdx) + props.scale.bandwidth() / 2 - props.cursorWidth / 2,
    },
    ref: api,
  });
